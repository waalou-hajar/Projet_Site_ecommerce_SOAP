<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	...
	Commande[] tab= proxy.allCommande();
%>
<!DOCTYPE html>
<html>
<head>
...
<tr><th> Id </th><th> Nom Client</th><th> Prix </th><th> Option </th></tr>
		<tr>
		<%
		if(tab!=null)
		{
		...
		<tr>
		    <td><%=tab[i].getIdCommande()%></td>
			<td><%=tab[i].getNom_client()%></td>
			<td><%=tab[i].getPrixTotale()%></td>
		    <td><a href="/Consommation_Site_Ecom/SupCmd?id=<%=tab[i].getIdCommande()%>">Supprimer</a></td>
			<td></td>
