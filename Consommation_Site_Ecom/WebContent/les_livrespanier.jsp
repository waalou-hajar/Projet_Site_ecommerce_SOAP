...
<tr><th>Id</th><th>Nom</th><th>Prix </th><th> Option </th></tr>
		<tr>
		<%
		if(tab!=null)
		{
		...
		<tr>
		    <td><%=tab[i].getId()%></td>
			<td><%=tab[i].getNom_livre()%></td>
			<td><%=tab[i].getPrix_livre()%></td>
			<td><a href="/Consommation_Site_Ecom/SUPliv?id=<%=tab[i].getId()%>">Supprimer</a></td>
...
<div >
<a href="cmd.jsp" class="btn yellow" > ajouter d'autres livres ! </a>  </br> 
</div>  
<div >
  <a href="login.jsp" class="btn black" style="margin-top:2px;"> Acheter ! </a>  </br> 
</div> 
</div>
